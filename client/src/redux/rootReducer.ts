...
import createContentModalReducer from '@redux/modules/contents/createContentModal'
...
import updateContentModalReducer from '@redux/modules/contents/updateContentModal'
